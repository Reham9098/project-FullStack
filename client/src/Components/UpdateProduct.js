...
import AddProductImage from "../Images/update.jpg";
...
const UpdateProduct = () => {
  ...
  useEffect(() => {
    if (productData) {
      ...
      setProductDiscribtion(productData.productDiscribtion || "");
      ...
      setValue("productQuantity", productData.productQuantity || "");
      setValue("productDiscribtion", productData.productDiscribtion || "");
  ...
  const onSubmit = () => {
    ...
    dispatch(updateProduct({ productId: productData._id, updatedData: updatedProduct }))
      .then(() => {
  ...
  return (
    <Container fluid className="p-0">
      <Row className="g-0 min-vh-100 d-flex">
        ...
        {/* Right Form – SAME STYLE AS AddProduct FORM */}
        <Col lg="6" className="d-flex align-items-start justify-content-center pt-5">
          ...
          >
            <h2 className="mb-4" style={{ fontWeight: "bold" }}>Update Product</h2>
